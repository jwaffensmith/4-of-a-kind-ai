...
An AI-powered word connections puzzle game inspired by NYT Connections. Players find groups of four words that share common themes, with puzzles generated by Claude AI featuring diverse categories and increasing difficulty levels.

## 🎮 Features

### Game Play
- **AI-Generated Puzzles**: Claude AI creates unique puzzles with diverse category themes
...
3. Go to Admin → Puzzles to review
...
- Anthropic Claude for AI puzzle generation
